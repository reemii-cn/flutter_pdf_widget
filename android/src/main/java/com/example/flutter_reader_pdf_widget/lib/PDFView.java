...
import com.example.flutter_reader_pdf_widget.lib.listener.OnErrorListener;
import com.example.flutter_reader_pdf_widget.lib.listener.OnLoadCompleteListener;
import com.example.flutter_reader_pdf_widget.lib.listener.OnPageChangeListener;
import com.example.flutter_reader_pdf_widget.lib.model.PagePart;
import com.example.flutter_reader_pdf_widget.lib.source.AssetSource;
import com.example.flutter_reader_pdf_widget.lib.source.ByteArraySource;
import com.example.flutter_reader_pdf_widget.lib.source.DocumentSource;
import com.example.flutter_reader_pdf_widget.lib.source.FileSource;
import com.example.flutter_reader_pdf_widget.lib.source.InputStreamSource;
import com.example.flutter_reader_pdf_widget.lib.source.UriSource;
import com.example.flutter_reader_pdf_widget.lib.util.ArrayUtils;
import com.example.flutter_reader_pdf_widget.lib.util.Constants;
import com.example.flutter_reader_pdf_widget.lib.util.NumberUtils;
...
import static com.example.flutter_reader_pdf_widget.lib.util.Constants.Cache.CACHE_SIZE;
...
public class PDFView extends SurfaceView {
    ...
    /**
     * Call back object to call before the page change
     */
    private OnPageChangeListener onBeforePageChangeListener;
    ...
    void showPage(int pageNb) {
        ...
        if (onBeforePageChangeListener != null) {
            onBeforePageChangeListener.onPageChanged(currentPage, getPageCount());
        }
    ...
    private void setOnBeforePageChangeListener(OnPageChangeListener onPageChangeListener) {
        this.onBeforePageChangeListener = onPageChangeListener;
    }
    ...
    private void dragPinchManagerDefaultPage(int defaultPage) {
        this.defaultPage = defaultPage;
    }
    ...
    public class Configurator {
        ...
        public Configurator beforePageChange(OnPageChangeListener onPageChangeListener) {
            this.onBeforePageChangeListener = onPageChangeListener;
            return this;
        }
        ...
        public void load() {
            ...
            PDFView.this.setOnBeforePageChangeListener(onBeforePageChangeListener);

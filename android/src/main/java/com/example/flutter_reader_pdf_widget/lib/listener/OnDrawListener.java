 ...
 */
package com.example.flutter_reader_pdf_widget.lib.listener;
...
public interface OnDrawListener {
     ...
     * @param yOffset
     */
    void onLayerDrawn(Canvas canvas, float pageWidth, float pageHeight, int displayedPage, float zoom, float xOffset, float yOffset);
}
